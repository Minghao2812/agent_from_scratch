...
# python -m naive_agent.xagent --prompt "你好，请介绍你自己"
# python -m naive_agent.xagent --prompt naive_agent/prompts/summarize.txt
# python -m naive_agent.xagent --prompt naive_agent/prompts/report.txt --skill
